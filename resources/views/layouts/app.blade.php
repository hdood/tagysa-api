...
<body style="min-height: 100vh;" class="flex bg-base-100 min-h-screen" data-theme="light">
    <aside class="hidden sm:flex sm:flex-col bg-base-200">
        <a href="#" class="inline-flex items-center justify-center h-20 w-20 bg-base-200 ml-2">
            <img src="/light_logo.png" class="scale-75" alt="tagy logo" srcset="">
        </a>
        <div class="flex-grow flex flex-col justify-between text-base-content bg-base-200">
    ...
    <div class="flex-grow text-base-content">
        <header class="flex items-center h-20 px-6 sm:px-10 bg-base-200">
            <button
